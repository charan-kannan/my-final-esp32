...
export function SensorCard({ sensor }: { sensor: SensorData }) {
  ...
  return (
    <Card className="flex flex-col border-primary/20 bg-card/50 backdrop-blur-sm transition-all hover:border-primary/40 hover:shadow-2xl hover:shadow-primary/10">
